...
<defs>
  ...
  <text x="80.0" y="290.8" text-anchor="start" fill="#FFFFFF" font-size="36" font-weight="800">UBS 마이크론 1600 훈풍 + 호르무즈 협상</text>
  <text x="80.0" y="343.0" text-anchor="start" fill="#FFFFFF" font-size="36" font-weight="800">용 노이즈 = -0.74% 제한 후퇴</text>
  ...
  <text x="142.0" y="416.75" text-anchor="start" fill="#FFFFFF" font-size="25" font-weight="700">UBS 마이크론 목표가 530→1600 3배 상향, 한국 반도체 </text>
  <text x="142.0" y="453.0" text-anchor="start" fill="#FFFFFF" font-size="25" font-weight="700">동조 강세 논리</text>
  ...
  <text x="142.0" y="508.75" text-anchor="start" fill="#FFFFFF" font-size="25" font-weight="700">호르무즈 노이즈 = 마지막 협상용 여론전 (이란 증시 정상 개장 </text>
  <text x="142.0" y="545.0" text-anchor="start" fill="#FFFFFF" font-size="25" font-weight="700">신호)</text>
  ...
  <text x="142.0" y="600.75" text-anchor="start" fill="#FFFFFF" font-size="25" font-weight="700">코스피 8,167 -0.74% / 코스닥 1,099 -2.99% </text>
  <text x="142.0" y="637.0" text-anchor="start" fill="#FFFFFF" font-size="25" font-weight="700">동반 후퇴</text>
  ...
  <text x="142.0" y="710.875" text-anchor="start" fill="#FFFFFF" font-size="25" font-weight="700">한국은행 금리 인상 시그널 — 코스피 영향 미미, 코스닥에는 부담</text>
  ...
  <text x="142.0" y="784.75" text-anchor="start" fill="#FFFFFF" font-size="25" font-weight="700">현대차 목표가 90만~120만 원, 보스턴 다이나믹스 상장이 핵심</text>
  <text x="142.0" y="821.0" text-anchor="start" fill="#FFFFFF" font-size="25" font-weight="700"> 변수</text>
...
</svg>`;document.body.innerHTML=svgText;const svgEl=document.querySelector('svg');const xml=new XMLSerializer().serializeToString(svgEl);const blob=new Blob([xml],{type:'image/svg+xml;charset=utf-8'});const url=URL.createObjectURL(blob);const img=new Image();try{await new Promise((r,j)=>{img.onload=r;img.onerror=()=>j('e');img.src=url;});}catch(e){return 'ERR';}const c=document.createElement('canvas');c.width=1080;c.height=1080;const cx=c.getContext('2d');cx.fillStyle='#0F172A';cx.fillRect(0,0,1080,1080);cx.drawImage(img,0,0,1080,1080);try{const d=c.toDataURL('image/jpeg',0.92);window._jpg_summary=d;return 'OK:summary:len='+d.length;}catch(e){return 'TAINT:'+e.message;}})()