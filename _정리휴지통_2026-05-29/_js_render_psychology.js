...
<defs>
  ...
  <text x="206.66666666666666" y="541.0" text-anchor="middle" fill="#94A3B8" font-size="20" font-weight="400">호르무즈 한 줄에 비중 단숨</text>
  <text x="206.66666666666666" y="570.0" text-anchor="middle" fill="#94A3B8" font-size="20" font-weight="400">에 변경</text>
  ...
  <text x="540.0" y="541.0" text-anchor="middle" fill="#94A3B8" font-size="20" font-weight="400">반도체 지겹다 댓글에 본질 </text>
  <text x="540.0" y="570.0" text-anchor="middle" fill="#94A3B8" font-size="20" font-weight="400">그대로인 종목 포기</text>
  ...
  <text x="873.3333333333333" y="541.0" text-anchor="middle" fill="#94A3B8" font-size="20" font-weight="400">8,228→8,167 -0.</text>
  <text x="873.3333333333333" y="570.0" text-anchor="middle" fill="#94A3B8" font-size="20" font-weight="400">74%에 과도한 매도 충동</text>
  ...
  <text x="80.0" y="724.05" text-anchor="start" fill="#FFFFFF" font-size="31" font-weight="700">본질(What) 점검 먼저, 그래도 불안하면 비중 대신 </text>
  <text x="80.0" y="769.0" text-anchor="start" fill="#FFFFFF" font-size="31" font-weight="700">현금 5~10% 추가 확보</text>
...
</svg>`;document.body.innerHTML=svgText;const svgEl=document.querySelector('svg');const xml=new XMLSerializer().serializeToString(svgEl);const blob=new Blob([xml],{type:'image/svg+xml;charset=utf-8'});const url=URL.createObjectURL(blob);const img=new Image();try{await new Promise((r,j)=>{img.onload=r;img.onerror=()=>j('e');img.src=url;});}catch(e){return 'ERR';}const c=document.createElement('canvas');c.width=1080;c.height=1080;const cx=c.getContext('2d');cx.fillStyle='#0F172A';cx.fillRect(0,0,1080,1080);cx.drawImage(img,0,0,1080,1080);try{const d=c.toDataURL('image/jpeg',0.92);window._jpg_psychology=d;return 'OK:psychology:len='+d.length;}catch(e){return 'TAINT:'+e.message;}})()